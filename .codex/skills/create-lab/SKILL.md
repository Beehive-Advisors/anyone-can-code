...
- Every Part has a conceptual question testing WHY (see `.codex/skills/.anyone-can-code-common/references/standards.md` for good/bad examples). The two tracks can carry the same question text (concepts are platform-neutral), but write it into both tracks — don't try to share across collapsibles.
